...
class MVTecSolver(object):
    CLSNAMES = [
        'Bear', 'Bird', 'Elephant', 'Parrot', 'Pig', 'Puppy', 'Scorpion', 'Turtle', 'Unicorn', 'Whale',
    ]
                ...
                for specie in species:
                    ...
                    for idx, img_name in enumerate(img_names):
                        info_img = dict(
                            ...
                            mask_path=f'{mask_dir.replace(cls_dir, cls_name)}/{img_name[:-4]}.png' if is_abnormal else '',
                            cls_name=cls_name,
                            specie_name=specie,
...
if __name__ == '__main__':
    ...
    # runner.run()
    runner = MVTecSolver(root='/fuxi_team14/users/haoyanghe/codes/data/ft_local/mad_real/MAD-Real')
    runner.run()
